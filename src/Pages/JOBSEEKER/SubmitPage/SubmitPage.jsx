...
const SubmitPage = () => {
  ...
  return (
    ...
    <div>
        ...
        <p className='text-sm poppins-light font-bold mb-10'>You will receive a status update in an email from <span className='text-gray-500 inline'>NextStep</span> within a few weeks of submitting your application. In the meantime, you can view and track all your applications in the <span className='text-gray-500 inline'>NextStep</span> <span className='text-green-500 inline'>Jobs</span> section at any time.</p>
