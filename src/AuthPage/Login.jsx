  ...
  return (
    <div className="flex w-full lg:w-1/3 flex-col justify-center items-center min-h-screen bg-white p-4">
      ...
      <div className="flex flex-col my-8">
        <div className="text-[#15294B] text-center font-bold poppins-semibold text-[2rem]">
          Your work people are here
        </div>
        <div className="text-black text-center text-1xl poppins-light">
      ...
      <div className="bg-[#f1f5fa] border border-[#c1c4c8] p-8 rounded-2xl shadow-xl max-w-md w-full">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-6">
            ...
            <div className="relative flex items-center border-b border-gray-300 rounded-lg px-3 py-2">
              <FaRegEnvelope className="text-black mr-3" />
              <input
                type="email"
                id="email"
                placeholder="Email"
                className="grow poppins-regular flex-1 min-w-0 outline-none text-black"
                value={email}
        ...
        <div className="flex justify-center space-x-4 mb-8">
          <button className="w-12 h-12 rounded-full hover:bg-gray-50">
